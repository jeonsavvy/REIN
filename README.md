...
![REIN 라이브 결제 완료 화면](docs/assets/rein-dashboard.png)
...
- 결제 후 Gemini가 늦어지면 구매한 데이터를 규칙 기반으로 정리하고 재결제하지 않음
- 규칙 기반 결과에서는 저하 상태를 명시하고, 기존 근거로 Gemini 분석만 다시 시도할 수 있음
...
검증 실행 `run_d15ee82b89cc4d179a7f664e513c1f59`은 총 3,000 atomic 테스트
