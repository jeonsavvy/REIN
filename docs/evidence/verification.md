...
- 최신 준비 리비전: `rein-00011-c7p`, 트래픽 100%
...
문제가 생기면 직전 검증 리비전 `rein-00009-q7s`으로 트래픽을 되돌릴 수 있다.
...
- 길이: 142.71초(2분 22.71초)
- 규격: 1920x1080, 30 fps, H.264 + 48 kHz AAC mono
- 크기: 8,440,119 bytes
- SHA-256:
  `343B5F718692B3BBF0F309DF25F8F7FA7FF56C6002C6405ABC293861F028FFD1`
- 음량: `mean_volume=-18.5 dB`, `max_volume=-1.5 dB`
...
`faster-whisper-small` 역전사는 문장별 평균 0.973, 최종 MP4 0.943의 정규화
...
- 검증한 공개 commit: `c8b73df1857bd5e50695863efeb107fc56d7240d`
